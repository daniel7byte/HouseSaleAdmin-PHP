...
while ($data = fgetcsv($file, 1000, ",")) {
  ...
  $queryUpdate = $mysql->query('UPDATE datoscasas SET dato26="'.$data['4'].'", dato27="'.$data['5'].'", dato28="'.$data['6'].'", dato24="'.$data['1'].'", dato6="'.$status.'", dato5="'.$data['3'].'", description="'.$data['7'].'" WHERE dato2="'.$data['0'].'";');
  if ($queryUpdate) {
    echo "OK (".$data['0'].")";
  }else{
